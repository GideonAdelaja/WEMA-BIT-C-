...
namespace ConsoleApp2
{
    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            var studentAge = new int[6] { 1, 2, 3, 4, 5, 6, };
            for(int counter = 0; counter < studentAge.Length; counter++)
            {
                Console.WriteLine(studentAge[counter]);
            }
            foreach(int counter2 in studentAge)
            {
                Console.WriteLine(studentAge);
            }

            //lIST
            //syntax List is aKeyword: List<datatype> varname = new List<datatype>();
            List<int> studentAge2 = new List<int>();
            studentAge2.Add(23);
            studentAge2.Add(45);
            //Console.WriteLine(studentAge2[1];
            for (int i = 0; i < studentAge2.Count; i++)
            {
                Console.WriteLine(studentAge2[i]);
            }
